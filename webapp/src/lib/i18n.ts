...
messages.en.txt_otpauth_uris = 'OTPAuth URIs';
messages.en.txt_otpauth_uris_placeholder = 'Paste your OTPAuth URIs here, one per line. Example:\notpauth://totp/GitHub%3Aluckyf1oat?secret=5SEK5NBJ5QMSXN7Z&issuer=GitHub\notpauth://totp/Twitter%3A%40kobus35?secret=IGI6DWABZNJF2CTT&issuer=Twitter';
messages.en.txt_please_enter_otpauth_uris = 'Please enter at least one OTPAuth URI.';
...
zhCNOverrides.txt_otpauth_uris = 'OTPAuth URI';
zhCNOverrides.txt_otpauth_uris_placeholder = '在此粘贴您的 OTPAuth URI，每行一个。示例：\notpauth://totp/GitHub%3Aluckyf1oat?secret=5SEK5NBJ5QMSXN7Z&issuer=GitHub\notpauth://totp/Twitter%3A%40kobus35?secret=IGI6DWABZNJF2CTT&issuer=Twitter';
zhCNOverrides.txt_please_enter_otpauth_uris = '请输入至少一个 OTPAuth URI。';
